...
public class IndexScanOperator extends QueryOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    try {
      ...
      int numRecords = (int) this.transaction.getNumRecords(this.tableName);
      float index = this.transaction.getStats(this.tableName).getReductionFactor(this.columnIndex, this.predicate, this.value);
      double rv = Math.ceil(index * (indexPages + numRecords));
      return (int) rv;
    } catch (Exception e) {
      return 0;
    }
