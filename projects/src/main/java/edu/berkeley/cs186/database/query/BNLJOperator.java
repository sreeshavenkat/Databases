...
public class BNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    int numLeftPages = this.getLeftSource().getStats().getNumPages();
    int numRightPages = this.getRightSource().getStats().getNumPages();
    float numPages = this.numBuffers - 2;
    return (int) ((Math.ceil(numLeftPages / numPages) * numRightPages) + numLeftPages);
  }
