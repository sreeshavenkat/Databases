...
public class TestOptimalQueryPlan {
  ...
  @Test(timeout=1000)
  @Category(StudentTestP4.class)
  public void test1() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    QueryPlan queryPlan = transaction.query(this.defaulTableName);
    ...
    while (outputIterator.hasNext()) {
      Record record = outputIterator.next();
      assertTrue(record.getValues().get(0) instanceof StringDataBox);
      assertTrue(record.getValues().get(1) instanceof StringDataBox);
      assertTrue(record.getValues().get(2) instanceof BoolDataBox);
      count++;
    }
    assertEquals(this.defaultNumRecords, count);
    transaction.end();
  ...
  public void test2() throws DatabaseException, QueryPlanException {
    ...
    while (outputIterator.hasNext()) {
      ...
      assertTrue(record.getValues().get(1) instanceof StringDataBox);
      assertTrue(record.getValues().get(2) instanceof BoolDataBox);
      assertTrue(record.getValues().get(3) instanceof IntDataBox);
      assertTrue(record.getValues().get(4) instanceof FloatDataBox);
      count++;
    }
    assertEquals(this.defaultNumRecords, count);
    transaction.end();
  ...
  @Test(timeout=1000)
  @Category(StudentTestP4.class)
  public void test3() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    QueryPlan queryPlan = transaction.query(this.defaulTableName);
  ...
  @Test(timeout=1000)
  @Category(StudentTestP4.class)
  public void test4() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    QueryPlan queryPlan = transaction.query(this.defaulTableName);
    ...
    while (recordIterator.hasNext()) {
      ...
      assertTrue(values.get(1) instanceof StringDataBox);
      assertTrue(values.get(2) instanceof BoolDataBox);
      assertTrue(values.get(3) instanceof FloatDataBox);
      assertTrue(values.get(4) instanceof IntDataBox);
    }
    transaction.end();
  }
